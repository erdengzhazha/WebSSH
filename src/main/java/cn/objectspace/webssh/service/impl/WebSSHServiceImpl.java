...
public class WebSSHServiceImpl implements WebSSHService {
    ...
    public void recvHandle(String buffer, WebSocketSession session) {
        ...
        try {
            logger.info("webSocket接收的消息 buffer: {}",buffer);
        ...
        if (ConstantPool.WEBSSH_OPERATE_CONNECT.equals(webSSHData.getOperate())) { // 如果是连接操作
            //找到刚才存储的ssh连接对象
        ...
        } else if (ConstantPool.WEBSSH_OPERATE_COMMAND.equals(webSSHData.getOperate())) {  // 如果是执行命令操作
    ...
    public void sendMessage(WebSocketSession session, byte[] buffer) throws IOException {
        ...
        logger.info("向Chorm发送消息 {}",textMessage.getPayload());
...
//        transToSSH(channel, "\r");
        ...
        try {
            //循环读取
            logger.info("进入了线程 {}",Thread.currentThread().getName());
            logger.info("初始化，服务端返回的数据");
    ...
    private void transToSSH(Channel channel, String command) throws IOException {
        logger.info("Jsch 向远程的计算机 发送command : {}",command);
        if (channel != null) {
