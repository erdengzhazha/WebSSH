...
public class WebSSHWebSocketHandler implements WebSocketHandler{
    ...
    public void afterConnectionEstablished(WebSocketSession webSocketSession) throws Exception {
        ...
        logger.info("【class】= {}",webSocketSession.getClass());
        logger.info("【class】= {}",webSocketSession);
        logger.info("【getAttributes】 = {}", JSON.toJSON(webSocketSession.getAttributes()));
        logger.info("【getPrincipal】 = {}",webSocketSession.getPrincipal());
        logger.info("【getUri】 = {}",webSocketSession.getUri());
        logger.info("握手成功后返回的head {}",webSocketSession.getHandshakeHeaders());
    ...
    public void handleMessage(WebSocketSession webSocketSession, WebSocketMessage<?> webSocketMessage) throws Exception {
        logger.info("【webSocketSession.getAttributes】= {}" , webSocketSession.getAttributes());
        logger.info("【webSocketSession.sessionId】 = {}",webSocketSession.getId());
